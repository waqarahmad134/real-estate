...
export default function Team() {
  return (
    <div>
      {" "}
      <section className="team-section py-[125px] overflow-hidden relative">
        <div className="container">
          <div className="grid sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-x-5 md:gap-x-[30px] mb-[-30px]">
            <div className="xl:pr-[20px] self-center mb-[30px] sm:col-span-3 lg:col-span-1 max-w-[500px]">
              ...
              <p>
                Huge number propreties availabe here for buy, sell and Rent, you
                a find here co-living property lots to choose here and enjoy
                huge.{" "}
              </p>
              <a
                href="blog-grid"
            ...
            <div className="text-center group mb-[30px]">
              <div className="relative rounded-[6px_6px_0px_0px]">
                <a href="agent-details">
                  <img
                    src="https://htmldemo.net/bery/bery/assets/images/team/person1.png"
                ...
                <ul className="flex flex-col absolute w-full top-[30px] left-0 overflow-hidden">
                  ...
                  <li className="translate-x-[0px] group-hover:translate-x-[30px] opacity-0 group-hover:opacity-100 transition-all duration-700 last:mb-0 mb-[15px]">
                    <a
                      href="#"
                      aria-label="svg"
                      className="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]"
