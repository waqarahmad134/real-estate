...
export default function Footer() {
  return (
    <>
      <footer
        className="footer bg-[#EEEEEE] pt-[80px] lg:pt-[120px] pb-30 md:pb-[80px] lg:pb-[110px] font-normal bg-no-repeat"
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div className="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
              <a href="index" className="block mb-[25px]">
                <img
              ...
              <ul className="inline-flex items-center justify-center mt-[20px]">
                <li className="first:ml-0 ml-[15px]">
                  <a
                    ...
                    aria-label="svg"
                    className="w-[22px] h-[22px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary"
                  >
                    <svg
                      width="7"
                      height="10"
